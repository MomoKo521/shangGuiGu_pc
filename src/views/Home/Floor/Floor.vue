...
export default {
  ...
  props:['list'],
  mounted(){
    // 为啥这里不适应nexTick+watch？
    // 你想想ListContainer组件使用轮播图的数据时候是在ListContainer组件发送axios异步请求获取数据的
    //而现在本组件的轮播图数据是在本组件发现异步请求的吗？不是！！ 是在home组件发送的  home组件已经获取渲染完且把值传送到本组件中了
    // 渲染swiper
      // 轮播图
    ...
    // direction: 'vertical', // 垂直切换选项
     loop: true, // 循环模式选项
      autoplay:true,//自动轮播
      autoplay: {
      disableOnInteraction: false,//用户触发其他事件依旧自动轮播
     },
